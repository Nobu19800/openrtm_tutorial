...
class FloatSeqToVelocity(OpenRTM_aist.DataFlowComponentBase):
    ...
    def __init__(self, manager):
        ...
        self._d_out = RTC.TimedVelocity2D(
        ...
        self._inIn.addConnectorDataListener(OpenRTM_aist.ConnectorDataListenerType.ON_BUFFER_WRITE, DataListener(
            self._outOut, self._d_out, self._rotation_by_position, self._velocity_by_position))
    ...
    def onInitialize(self):
        ...
        self.bindParameter("rotation_by_position",
                           self._rotation_by_position, "-0.02")
        self.bindParameter("velocity_by_position",
                           self._velocity_by_position, "0.002")
